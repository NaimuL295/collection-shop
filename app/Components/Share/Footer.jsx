...
//             <p className="text-sm">📞 +880XXXXXXXXXXXXX</p>
//             <p className="text-sm">📩 XXXX@gmail.com</p>
//             <p className="text-sm">🏢 XXX, XXXX, Tangail</p>
//           </div>
...
//               <Link href="/terms" className="block hover:text-blue-300">Terms</Link>
//               <Link href="/policy" className="block hover:text-blue-300">Return Policy</Link>
...
//             <div className="text-sm space-y-1">
//               <Link href="#" className="block hover:text-blue-300">Facebook</Link>
//               <Link href="#" className="block hover:text-blue-300">Twitter</Link>
//               <Link href="#" className="block hover:text-blue-300">Instagram</Link>
//             </div>
//           </div>
//         </div>
...
//           <p className="text-sm mb-2">We accept: Visa, MasterCard, PayPal</p>
//           <p className="text-sm">© 2024 Nokshipolli. All Rights Reserved.</p>
//         </div>
//       </div>
//     </footer>
//   )
